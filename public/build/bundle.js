...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = `Hello ${/*applicationName*/ ctx[0]}!`;
    			t3 = space();
    			p = element("p");
    			t4 = text("Visit the ");
    			a = element("a");
    			...
    			add_location(h1, file, 5, 1, 92);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file, 6, 14, 140);
    			add_location(p, file, 6, 1, 127);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ config, applicationName });
